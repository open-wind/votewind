...
namespace DotNetCoords
{
  ...
  public sealed class MGRSRef : CoordinateSystem 
  {
    ...
    {
      private readonly long _letter;            /* letter representing latitude band  */
    ...
    */
    ...
    public UTMRef ToUTMRef() 
    {
      ...
      Get_Grid_Values(out long ltr2LowValue, out long ltr2HighValue, out var falseNorthing);
