...
export const TurbineHeightModal = ({ open, onClose, selected, onSelect }) => {
  ...
  return (
    <>
      <div className="fixed w-full h-full top-0 left-0 inset-0 z-40 isolate bg-black-50 flex items-center justify-center"></div>

      <div className="fixed w-full h-full top-0 left-0 inset-0 z-50 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-lg w-full max-w-250px sm-max-w-330px z-1001 p-6">
